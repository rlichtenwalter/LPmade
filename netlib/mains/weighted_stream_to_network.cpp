...
void usage( const char* binary ) {
	cerr << "Usage: " << binary << " [options] seperator iindex jindex windex\n";
...
int main( int argc, char* argv[] ) {
	...
	const unsigned int wIndex = atoi( argv[optind++] );

	WeightedNetwork network = WeightedNetwork::readWeightedStream( cin, separator, iIndex, jIndex, wIndex, ignoreSelfEdges );
	network.print( cout );
