...
import weka.classifiers.trees.j48.HDIGModelSelection;
...
/**
<!-- globalinfo-start -->
 * Class for generating a pruned or unpruned HD-IG product distance decision tree.
<!-- options-start -->
 * Valid options are: <p/>
 * 
 * <pre> -U
 ...
 */
public class HDIGTree extends Classifier implements OptionHandler, Drawable, Matchable, Sourcable, WeightedInstancesHandler, Summarizable, AdditionalMeasureProducer, TechnicalInformationHandler {
	...
	public String globalInfo() {
		return "Class for generating a pruned or unpruned HD-IG product decision tree. For more " +
				"information, see\n\n" +
	...
	public TechnicalInformation getTechnicalInformation() {
		...
		result.setValue( Field.AUTHOR, "Ryan N. Lichtenwalter" );
